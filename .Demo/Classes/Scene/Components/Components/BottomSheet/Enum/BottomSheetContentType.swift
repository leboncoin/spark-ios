...
enum BottomSheetContentType: String, CaseIterable {
    ...
    var text: String {
        switch self {
        case .shortText: "Quisque viverra tincidunt diam sed eleifend. Phasellus malesuada vitae dui a pharetra. Aliquam sagittis tincidunt dolor, non aliquam quam vestibulum nec. Vestibulum sodales facilisis tellus, eu auctor enim efficitur vel. Integer quis elementum felis."
