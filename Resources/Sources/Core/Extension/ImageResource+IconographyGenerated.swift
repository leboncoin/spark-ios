...
public extension ImageResource {
    ...
    enum Spark {
        ...
        public static let cameraAI = ImageResource(name: "Global/CameraAI", bundle: .current)
        ...
        public static let microphoneAI = ImageResource(name: "Global/MicrophoneAI", bundle: .current)
        ...
        public static let paintbrushAI = ImageResource(name: "Global/PaintbrushAI", bundle: .current)
