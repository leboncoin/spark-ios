...
let package = Package(
    ...
    products: [
        ...
        // TODO: Remove if not necessary ! Then update the skills
...
//
//        // Component products (alphabetically sorted)
//        .library(
...
//            targets: ["SparkComponentInputOTP"]
//        ),
//        .library(
//            name: "SparkComponentInputOTPTesting",
//            targets: ["SparkComponentInputOTPTesting"]
//        ),
//        .library(
...
//            targets: ["SparkComponentSegmentedControl"]
//        ),
//        .library(
//            name: "SparkComponentSegmentedControlTesting",
//            targets: ["SparkComponentSegmentedControlTesting"]
//        ),
//        .library(
