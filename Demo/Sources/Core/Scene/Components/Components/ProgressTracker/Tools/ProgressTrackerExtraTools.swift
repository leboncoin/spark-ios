...
struct ProgressTrackerExtraTools: ComponentExtraTools {
    ...
    let documentationLink: String? = "https://leboncoin.github.io/spark-ios/sparkcomponentprogresstracker/documentation/sparkcomponentprogresstracker/documentation"
