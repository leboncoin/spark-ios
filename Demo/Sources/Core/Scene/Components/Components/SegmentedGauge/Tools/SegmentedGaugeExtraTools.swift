...
struct SegmentedGaugeExtraTools: ComponentExtraTools {
    ...
    let documentationLink: String? = "https://leboncoin.github.io/spark-ios/sparkcomponentsegmentedgauge/documentation/sparkcomponentsegmentedgauge/documentation"
